                    ...
                    <div class="widget-content nopadding">
                        <form enctype="multipart/form-data" class="form-horizontal" method="POST" action="{{ url('/admin/edit-product/'.$product['id']) }}" name="edit-product" id="edit-product" novalidate="novalidate">@csrf
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea class="textarea_editor span12" rows="15" name="description" id="description">{{ $product['description'] }}</textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Material and Care</label>
                                <div class="controls">
                                    <textarea class="textarea_editor span12" rows="3" name="care" id="care">{{ $product['care'] }}</textarea>
                                </div>
                            </div>
                            <div class="control-group">
