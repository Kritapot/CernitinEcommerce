                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{ url('/admin/update-category/'.$category['id']) }}" name="edit-category" id="edit-category" novalidate="novalidate">{{ csrf_field() }}
